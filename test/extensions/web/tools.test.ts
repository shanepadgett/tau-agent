...
import { createCodeSearchTool } from "../../../src/extensions/web/codesearch.ts";
import webExtension from "../../../src/extensions/web/index.ts";
import { clampInteger, normalizeTimeout } from "../../../src/extensions/web/limits.ts";
import { createWebSearchTool } from "../../../src/extensions/web/websearch.ts";
import {
	extensionContext,
	type FetchCallInit,
	firstText,
