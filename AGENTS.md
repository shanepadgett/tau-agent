...
- After code changes, run `mise run check` with available `bash` tool and fix errors, warnings, and infos. If it reports auto-fixed files and no errors, do not rerun just to confirm formatting.
