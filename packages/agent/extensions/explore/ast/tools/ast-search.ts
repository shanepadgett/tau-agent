...
} from "../format/ast-search.ts";
import { astSearch } from "../queries/ast-search.ts";
...
const astSearchParams = Type.Object(
	{
		...
		language: Type.Optional(
			Type.String({
				description:
					"Engine-registered language id (typescript, tsx, go, rust, c_sharp, java, kotlin, swift, odin). Required for directories; must match file extension when both given.",
			}),
		),
