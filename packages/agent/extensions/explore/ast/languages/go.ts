...
function leafMember(
	...
	return {
		...
		endByte: endNode.endIndex,
		signatureEndByte: endNode.endIndex,
			...
			const decl = applyDoc(
				{
					...
					signatureEndByte: open.startIndex,
					bodyStartByte: open.startIndex,
					bodyEndByte: typeNode.endIndex,
					visibility: visibilityFor(name),
					exported: goExported(name),
			...
			const decl = finishDecl(
				{
					...
					startByte: spanStart.startIndex,
