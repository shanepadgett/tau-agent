...
import type { DeclKind } from "../../../src/ast/ir.ts";
import {
	formatDiscoverEmpty,
	formatDiscoverFile,
	formatDiscoverFooters,
	groupDiscoverByFile,
} from "../../../src/ast/format/discover.ts";
import { discover, type DiscoverQuery, type DiscoverSurface } from "../../../src/ast/queries/discover.ts";
