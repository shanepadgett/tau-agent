...
export type FileIr = {
	...
	imports: ImportRef[];
	/**
	 * Call sites in top-level statements, owned by no declaration.
	 * Relationship queries read these; they are not declarations and never
	 * appear in outline, discover, or declaration counts.
	 */
	fileCalls: CallSite[];
