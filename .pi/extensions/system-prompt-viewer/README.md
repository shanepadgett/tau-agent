...
Snapshots include Soul's saved baseline, admitted context updates, and active tool schema summaries. They are display-only session entries and never enter model context.
