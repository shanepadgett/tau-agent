...
`/interview [topic]` creates `.working/interviews/<date-time>/decisions.md`, enables interview tools, and sends a hidden instruction to run a structured interview.
